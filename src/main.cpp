...
void ResendWalletTransactions(bool fSeedcoin) {
    g_signals.Broadcast(fSeedcoin);
}
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1) 
        nSubsidy = 3873750 * COIN;
    else if (nHeight <= 2500 && nHeight > 1) 
        nSubsidy = 2.5 * COIN;	
    else if (nHeight <= 20000 && nHeight > 2500) 
        nSubsidy = 50 * COIN;
...
return "Si1RJrvG1r1oVnmShYuYYkYtNQSvB7g9K5";
}
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 > 201 && pindexBest->nHeight+1 <= 2500) {
	nSubsidy = 1 * COIN;
    }
    else if (pindexBest->nHeight+1 > 2500 && pindexBest->nHeight+1 <= 20000)	{
	nSubsidy = 50 * COIN; 
    }
    else if (pindexBest->nHeight+1 > 20000 && pindexBest->nHeight+1 <= 500000)	{
	nSubsidy = 25 * COIN; 
    }
    else if (pindexBest->nHeight+1 > 500000 && pindexBest->nHeight+1 <= 750000) {
        nSubsidy = 20 * COIN;
    }
    else if (pindexBest->nHeight+1 > 750000 && pindexBest->nHeight+1 <= 1000000) {
        nSubsidy = 15 * COIN;
    }
    else if (pindexBest->nHeight+1 > 1000000 && pindexBest->nHeight+1 <= 1250000) {
        nSubsidy = 10 * COIN;
    }
    else if (pindexBest->nHeight+1 > 1250000 && pindexBest->nHeight+1 <= 1500000) {
        nSubsidy = 5 * COIN;
    }
    else if (pindexBest->nHeight+1 > 1500000 && pindexBest->nHeight+1 <= 1750000) {
        nSubsidy = 4.5 * COIN;
    }
    else if (pindexBest->nHeight+1 > 1750000 && pindexBest->nHeight+1 <= 2000000) {
        nSubsidy = 4 * COIN;
    }
    else if (pindexBest->nHeight+1 > 2000000 && pindexBest->nHeight+1 <= 2250000) {
        nSubsidy = 3.5 * COIN;
    }
    else if (pindexBest->nHeight+1 > 2250000 && pindexBest->nHeight+1 <= 2500000) {
        nSubsidy = 3 * COIN;
    }
    else if (pindexBest->nHeight+1 > 2500000) {
        nSubsidy = 2.5 * COIN;
    }	
    return nSubsidy + nFees;
}
            ...
            if(IsProofOfStake() && pindex != NULL){
                if(pindex->GetBlockHash() == hashPrevBlock){
                    ...
                    if (pindex->nHeight >= 200) {
                        CSeedcoincoinAddress devRewardAddress(getDevAddress(pindex->nHeight + 1));
