...
#endif
    setObjectName("Seedcoin");
    setStyleSheet("#Seedcoin { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(tr("&About Seedcoin"), this);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 14px; font-weight: 400; font-variant: small-caps; padding: 3px; border: none;}"
                           ...
                           "#tabs { color: #000000; background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #69A80A, stop: 1 #000000); border: none; padding-top: 0px; padding-bottom: 0px; }");
