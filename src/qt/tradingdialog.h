...
private slots:
    ...
    QString BuyXSD(QString OrderType, double Quantity, double Rate);
    QString SellXSD(QString OrderType, double Quantity, double Rate);
