...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: Seedcoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: Seedcoind.pid)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeSeedcoinamount=<n> " + _("Keep N Seedcoin anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Seedcoin is probably already running."), strDataDir));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Seedcoin version %s (%s)\n", FormatFullVersion(), CLIENT_DATE);
    ...
    nAnonymizeSeedcoinAmount = GetArg("-anonymizeSeedcoinamount", 0);
    if(nAnonymizeSeedcoinAmount > 999999) nAnonymizeSeedcoinAmount = 999999;
    if(nAnonymizeSeedcoinAmount < 2) nAnonymizeSeedcoinAmount = 2;
    ...
    LogPrintf("Anonymize Seedcoin Amount %d\n", nAnonymizeSeedcoinAmount);

    /* Denominations
       A note about convertability. Within Darksend pools, each denomination
       is convertable to another.
       For example:
       1XSD+1000 == (.1XSD+100)*10
       10XSD+10000 == (1XSD+1000)*10
    */
